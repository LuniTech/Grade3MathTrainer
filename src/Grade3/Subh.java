 ...
 * @author ZIPHO LUNIKA
 */
public class Subh extends javax.swing.JFrame {

    /** Creates new form Addtionh */
    public Subh() {
        initComponents();
    }
    int score=0;
    ...
    {
    int n1=(int)(Math.random()*5990000)+10000;
        int n2=(int)(Math.random()*5990000)+10000;
if(n2>n1)
{
        num1.setText(String.valueOf(n2));
num2.setText(String.valueOf(n1));
        }
 else
{
...
int pic=(int)(Math.random()*4)+1;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Hard Mode", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Comic Sans MS", 3, 18))); // NOI18N
