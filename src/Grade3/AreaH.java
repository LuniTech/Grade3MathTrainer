 ...
 * @author ZIPHO LUNIKA
 */
public class AreaH extends javax.swing.JFrame {
...
int score=0;
   ...
   public void SetShape1()
    {
        num1=(int)(Math.random()*400)+100;
        num2=(int)(Math.random()*400)+100;
        num3=(int)(Math.random()*400)+100;
        num4=(int)(Math.random()*400)+100;
      while(num1<=num2)
      {
...
T.setText(String.valueOf(total));
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Area -Hard", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Snap ITC", 0, 36))); // NOI18N
        ...
        CAnswer.setFont(new java.awt.Font("Snap ITC", 3, 36));
        ...
        eish.setFont(new java.awt.Font("Tahoma", 3, 36));
        jPanel1.add(eish);
        ...
        jLabel16.setFont(new java.awt.Font("Chiller", 1, 36));
        jLabel16.setText("SCORE:");
        jPanel1.add(jLabel16);
        jLabel16.setBounds(30, 510, 130, 30);

        jLabel17.setFont(new java.awt.Font("Chiller", 1, 36));
        jLabel17.setText("TOTAL:");
        jPanel1.add(jLabel17);
        jLabel17.setBounds(30, 560, 140, 40);

        S.setFont(new java.awt.Font("Chiller", 1, 24));
        S.setText("S");
        jPanel1.add(S);
        S.setBounds(190, 510, 90, 30);

        T.setFont(new java.awt.Font("Chiller", 1, 24));
        T.setText("T");
        jPanel1.add(T);
