 ...
 * @author ZIPHO LUNIKA
 */
public class AreaM extends javax.swing.JFrame {
...
int score=0;
   ...
   public void SetShape1()
    {
        num1=(int)(Math.random()*50)+50;
        num2=(int)(Math.random()*50)+50;
        num3=(int)(Math.random()*50)+50;
        num4=(int)(Math.random()*50)+50;
      while(num1<=num2)
      {
...
T.setText(String.valueOf(total));
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Area -Medium", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Snap ITC", 0, 36))); // NOI18N
